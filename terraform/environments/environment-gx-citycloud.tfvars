...
cloud_provider            = "gx-citycloud"                              # has to be the same value as in the Makefile (environment) and in the clouds.yaml
dns_domain                = "gardener-1.23technologies.xyz"         # domain for the gardener instace
flavor               = "4C-16GB-50GB"                           # flavor for the garden-cluster kubernetes control-plane nodes
flavor_main               = "4C-16GB-50GB"                           # flavor for the garden-cluster kubernetes control-plane nodes
flavor_mgmt               = "1C-1GB-50GB"                           # flavor for the installation and management server
...
external                    = "ext-net"                              # public network name
...
number_of_controlplane_nodes = 1
number_of_workers = 1
ssh_username = "ubuntu"
prefix            = "capi"
